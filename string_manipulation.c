...
//Variable(s) to be used in the program
  ...
  //Read in the string for the user
...
//    myString[strcspn(myString,"\n")]='\0';
  ...
  //Display the occurrence of a character and string in a string using strchr() and strstr() respectively
  char s4[]="coffee";
  ...
  printf("\nThe lenght of the string is \"%s\" is %d characters.",str3,strlen(str3));
